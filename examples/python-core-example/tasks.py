...
@task
def build_targz(c):
    """Package python_core_example code as a tar.gz file."""
    _build_targz(c)
...
def build_lambdas(c):
    ...
    # Copy python_core_example source code into virtual env directory required for Lambda
    c.run(
